...
public class VmRuntimeWebAppContextTest  {
  ...
  @Test
  public void testRequestTicketNeverClear() throws Exception {
  ...
  @Test
  public void testRequestTicketClearAfterClose() throws Exception {
    VmRuntimeInterceptor.setDftClearTicket(VmRuntimeInterceptor.ClearTicket.ON_LAST);
    ReportProxyServlet servlet = new ReportProxyServlet();
    context.addServlet(new ServletHolder("test", servlet),"/*");
    String response = connector.getResponses("GET / HTTP/1.0\r\n"+
       VmApiProxyEnvironment.TICKET_HEADER+": request-ticket\r\n\r\n");
  ...
  @Test
  public void testRequestTicketClearAfterCommit() throws Exception {
