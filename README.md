...
the image, you need to build it with either a local docker installation or environment variables pointing to a remote docker instance. For installing docker see [here](https://docs.docker.com/engine/installation/).
