...
public class LoggingTest extends VmRuntimeTestBase{
  ...
  public void testGet() throws Exception {
    ...
    try(BufferedReader in = new BufferedReader(new InputStreamReader(new FileInputStream(log), StandardCharsets.ISO_8859_1));) {
      String line;
      ...
      assertThat(data.message,org.hamcrest.Matchers.containsString("LoggingServlet doGet: not null"));
